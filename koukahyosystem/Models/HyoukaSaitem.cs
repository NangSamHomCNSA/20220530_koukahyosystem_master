...
namespace koukahyosystem.Models
{
    public class HyoukaSaitem
    {
        ...
        public IEnumerable<SelectListItem> HyokashaList { get; set; }
        public string hyoukacode { get; set; }

        public List<hyokalist> hyokalist { get; set; }
    }
    public class hyokalist
    {
